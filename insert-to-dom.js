...
<aside class="sidebar no-print">
  <div class="os-v2-container">
    ...
    <a class="sidebar__link sidebar__link--home" href="index.html">
      <svg class="os-v2-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 75 48">
  ...
  <a class="sidebar__link sidebar__link--about-me" href="about-me.html">
    <svg class="sidebar__link--about-me-svg" version="1.1" viewBox="0 0 26.458 26.458" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg class="sidebar__link--about-me-mustache version="1.1" viewBox="0 0 26.458 26.458" xmlns="http://www.w3.org/2000/svg">
     <g>
  ...
  <a class="sidebar__link sidebar__link--vid" href="videos.html">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26.458 26.458"><circle cx="13.245" cy="283.817" r="12.548" stroke="#000" stroke-width=".864" stroke-linecap="round" fill="none" transform="translate(0 -270.542)"/><g stroke="#000" stroke-linecap="round">
